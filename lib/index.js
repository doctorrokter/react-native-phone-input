...
export default class PhoneInput extends Component {
  ...
  onChangePhoneNumber(number) {
    ...
    this.updateFlagAndFormatNumber(number, onChangePhoneNumber.bind(null, number));
  }
  ...
  updateFlagAndFormatNumber(number, actionAfterSetState = null) {
    ...
    if (number) {
      ...
      if (!allowZeroAfterCountryCode) {
        formattedPhoneNumber = this.possiblyEliminateZeroAfterCountryCode(formattedPhoneNumber);
      }
